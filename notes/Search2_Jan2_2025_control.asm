...
0000000000401030 <clock_gettime@plt>:
  401030:	ff 25 e2 2f 00 00    	jmpq   *0x2fe2(%rip)        # 404018 <clock_gettime@GLIBC_2.17>
...
0000000000401150 <main>:
  ...
  4013f8:	48 8b 3d c1 2c 00 00 	mov    0x2cc1(%rip),%rdi        # 4040c0 <stdout@@GLIBC_2.2.5>
  ...
  40142e:	48 8b 15 9b 2c 00 00 	mov    0x2c9b(%rip),%rdx        # 4040d0 <stdin@@GLIBC_2.2.5>
  401435:	be f4 01 00 00       	mov    $0x1f4,%esi
  40143a:	48 89 ef             	mov    %rbp,%rdi
  40143d:	e8 4e fc ff ff       	callq  401090 <fgets@plt>
  401442:	be a0 21 40 00       	mov    $0x4021a0,%esi
  ...
  40145e:	48 8b 0d 5b 2c 00 00 	mov    0x2c5b(%rip),%rcx        # 4040c0 <stdout@@GLIBC_2.2.5>
...
00000000004014e0 <_start>:
  ...
  4014ff:	ff 15 db 2a 00 00    	callq  *0x2adb(%rip)        # 403fe0 <__libc_start_main@GLIBC_2.34>
  401505:	f4                   	hlt    
...
0000000000401520 <deregister_tm_clones>:
  401520:	48 8d 3d 89 2b 00 00 	lea    0x2b89(%rip),%rdi        # 4040b0 <__TMC_END__>
  401527:	48 8d 05 82 2b 00 00 	lea    0x2b82(%rip),%rax        # 4040b0 <__TMC_END__>
  40152e:	48 39 f8             	cmp    %rdi,%rax
  401531:	74 15                	je     401548 <deregister_tm_clones+0x28>
  401533:	48 8b 05 ae 2a 00 00 	mov    0x2aae(%rip),%rax        # 403fe8 <_ITM_deregisterTMCloneTable>
...
0000000000401550 <register_tm_clones>:
  401550:	48 8d 3d 59 2b 00 00 	lea    0x2b59(%rip),%rdi        # 4040b0 <__TMC_END__>
  401557:	48 8d 35 52 2b 00 00 	lea    0x2b52(%rip),%rsi        # 4040b0 <__TMC_END__>
  ...
  401574:	48 8b 05 7d 2a 00 00 	mov    0x2a7d(%rip),%rax        # 403ff8 <_ITM_registerTMCloneTable>
...
0000000000401590 <__do_global_dtors_aux>:
  ...
  401594:	80 3d 4d 2b 00 00 00 	cmpb   $0x0,0x2b4d(%rip)        # 4040e8 <completed.0>
  ...
  4015a6:	c6 05 3b 2b 00 00 01 	movb   $0x1,0x2b3b(%rip)        # 4040e8 <completed.0>
  4015ad:	5d                   	pop    %rbp
  4015ae:	c3                   	retq   
  4015af:	90                   	nop
  4015b0:	c3                   	retq   
...
0000000000401660 <init_thread>:
  ...
  4016d7:	48 8b 3d e2 29 00 00 	mov    0x29e2(%rip),%rdi        # 4040c0 <stdout@@GLIBC_2.2.5>
  ...
  4016f9:	f2 0f 59 05 27 0a 00 	mulsd  0xa27(%rip),%xmm0        # 402128 <__dso_handle+0x120>
  401700:	00 
  401701:	f2 48 0f 2a ce       	cvtsi2sd %rsi,%xmm1
  401706:	f2 0f 59 0d 22 0a 00 	mulsd  0xa22(%rip),%xmm1        # 402130 <__dso_handle+0x128>
  40170d:	00 
...
00000000004017e0 <getMutableCopy>:
  ...
  40182b:	f2 0f 59 05 75 09 00 	mulsd  0x975(%rip),%xmm0        # 4021a8 <__dso_handle+0x1a0>
  401832:	00 
  401833:	66 0f ef c9          	pxor   %xmm1,%xmm1
  401837:	48 2b 4c 24 08       	sub    0x8(%rsp),%rcx
  40183c:	be 38 21 40 00       	mov    $0x402138,%esi
  401841:	b8 01 00 00 00       	mov    $0x1,%eax
  401846:	48 8b 3d 73 28 00 00 	mov    0x2873(%rip),%rdi        # 4040c0 <stdout@@GLIBC_2.2.5>
  ...
  40185e:	48 8b 0d 5b 28 00 00 	mov    0x285b(%rip),%rcx        # 4040c0 <stdout@@GLIBC_2.2.5>
  ...
  401876:	bf 87 21 40 00       	mov    $0x402187,%edi
  ...
  4018aa:	bf 68 21 40 00       	mov    $0x402168,%edi
...
00000000004018c0 <WordListIsSafe>:
  ...
  401ae4:	48 8b 3d f5 25 00 00 	mov    0x25f5(%rip),%rdi        # 4040e0 <stderr@@GLIBC_2.2.5>
  401aeb:	89 d9                	mov    %ebx,%ecx
  401aed:	44 89 f2             	mov    %r14d,%edx
  401af0:	31 c0                	xor    %eax,%eax
  401af2:	be 30 22 40 00       	mov    $0x402230,%esi
  ...
  401b0f:	c3                   	retq   
  401b10:	48 8b 3d c9 25 00 00 	mov    0x25c9(%rip),%rdi        # 4040e0 <stderr@@GLIBC_2.2.5>
  401b17:	89 d9                	mov    %ebx,%ecx
  401b19:	44 89 f2             	mov    %r14d,%edx
  401b1c:	45 0f b6 c0          	movzbl %r8b,%r8d
  401b20:	be 90 22 40 00       	mov    $0x402290,%esi
  ...
  401c69:	48 8b 3d 70 24 00 00 	mov    0x2470(%rip),%rdi        # 4040e0 <stderr@@GLIBC_2.2.5>
  401c70:	40 0f b6 ce          	movzbl %sil,%ecx
  401c74:	44 89 f2             	mov    %r14d,%edx
  401c77:	31 c0                	xor    %eax,%eax
  401c79:	be f0 22 40 00       	mov    $0x4022f0,%esi
  ...
  401c91:	48 8b 3d 48 24 00 00 	mov    0x2448(%rip),%rdi        # 4040e0 <stderr@@GLIBC_2.2.5>
  401c98:	44 89 f2             	mov    %r14d,%edx
  401c9b:	31 c0                	xor    %eax,%eax
  401c9d:	40 0f b6 cd          	movzbl %bpl,%ecx
  401ca1:	be b0 21 40 00       	mov    $0x4021b0,%esi
